  ...
  return (
    <div className="animate-fade-in pb-6">
      <div className="relative h-44 w-full bg-zinc-100">
        ...
        <Link
          href="/buyer/home"
          className="absolute left-3 top-3 flex h-9 w-9 items-center justify-center rounded-full bg-white/90 shadow-card"
        >
      ...
      <div className="px-4">
        <div className="-mt-8 flex items-end gap-3">
          <div className="h-16 w-16 overflow-hidden rounded-2xl border-4 border-white bg-white shadow-elevated">
            {store.logoUrl ? (
              <Image src={store.logoUrl} alt="" width={64} height={64} className="h-full w-full object-cover" />
            ) : (
        ...
        <h1 className="mt-3 text-xl font-extrabold text-zinc-900">{store.name}</h1>
        ...
        {store.description && <p className="mt-3 text-sm leading-relaxed text-zinc-600">{store.description}</p>}
