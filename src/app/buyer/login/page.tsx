  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-[480px] flex-col bg-white px-6 pb-10 pt-8">
      ...
      <div className="mt-8 flex flex-col items-center text-center">
        <LogoMark size={48} />
        <h1 className="mt-4 text-xl font-extrabold text-zinc-900">Welcome, shopper 🛒</h1>
        <p className="mt-1 text-sm text-zinc-500">
          Log in with your mobile number to discover local stores near you.
        </p>
      </div>
