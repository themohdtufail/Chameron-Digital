    ...
    <div className="animate-fade-in">
      ...
      <div className="px-4 py-4 lg:px-10 lg:py-6">
        ...
        {orders && orders.length === 0 && (
          <EmptyState icon={ClipboardList} title="No orders here" description="Orders will show up as they come in." />
        )}
            ...
            {orders.map((order) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-zinc-500">{order.buyer.name ?? order.buyer.phone}</p>
